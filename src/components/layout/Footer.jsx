            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div className="text-white">
                  <div>Unit A10 539 Bizspace Business Park Kings Road Tyseley</div>
                  <div>Tyseley Birmingham</div>
                  <div>B11 2AL</div>
                </div>
              </motion.div>
              ...
              >
                ...
                <a href="tel:+923366424379" className="text-white hover:text-primary transition-colors">
                  +92 336 6424379
                </a>
              </motion.div>
              ...
              >
                ...
                <a href="mailto:info@advertio.online" className="text-white hover:text-primary transition-colors">
                  info@advertio.online
                </a>
              </motion.div>
            </div>

            {/* Logo - Keep rotation animation on mobile */}
            <motion.div
              initial={isMobile ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.8 }}
              whileInView={isMobile ? { opacity: 1, scale: 1 } : { opacity: 1, scale: 1 }}
              viewport={{ once: true }}
              transition={isMobile ? { duration: 0 } : { duration: 0.6, delay: 0.5 }}
              className="absolute top-16 -right-8 md:top-8 md:-right-8"
              style={isMobile ? { transform: 'none' } : {}}
            >
              <motion.div 
                ...
                style={{
                  // Ensure rotation works on mobile - don't reset this transform
